...
class TabMain(tk.Frame):
    def __init__(self, parent, manager, *args, **kwargs):
        ...
        self.browser_type = tk.StringVar(value=manager.get_browser_type())
        ...
        headless_checkbox.place(x=180, y=75)
        ...
        auto_restart_checkbox.place(x=255, y=75)

        # Browser type selection
        browser_label = tk.Label(self, text="Browser:", borderwidth=2)
        browser_label.place(x=180, y=94)
        ...
        browser_dropdown.place(x=240, y=94)
        browser_dropdown.bind("<<ComboboxSelected>>", 
            lambda event: self.manager.set_browser_type(self.browser_type.get()))
