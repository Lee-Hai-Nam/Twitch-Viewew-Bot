...
class InstanceManager:
    def __init__(
        ...
        self.browser_type = browser_type.lower()  # Add browser_type
    ...
    def set_browser_type(self, new_value: str):
        logger.info(f"Setting browser type to " + str(new_value))
        self.browser_type = new_value.lower()
    ...
    def spawn_instance_thread(self, target_url, status_reporter, browser_instance_id):
        ...
        with self.manager_lock:
            ...
            browser_instance = site_class(
                ...
                browser_type=self.browser_type,  # Pass browser_type
            )
